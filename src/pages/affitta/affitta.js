...
const Affitta = () => {
    ...
    const handleDropdown = (event) => {
        ...
        if (event.target.innerText === 'Affitte' || event.target.className === 'arrow down buyArrow' ||  event.target.className === 'arrow up down buyArrow'){
        ...
        if (event.target.innerText !== 'Affitte' && event.target.className !== 'type' && event.target.className !== 'arrow down buyArrow' && event.target.className !== 'arrow up down buyArrow' && event.target.className !== 'arrow down typeArrow' && event.target.className !== 'arrow up down typeArrow'){
    ...
    const handleChange = (event) => {
        ...
        if (checked){
            ...
            setdropType(!dropdownType)
            setTypeArrow(!rotateTypeArrow)
            navigate(`/affitta/${value}/${params.province}`)
        }
